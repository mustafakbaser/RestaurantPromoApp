 ...
 */
class HakkimizdaFragment extends Fragment {
    ...
    public static HakkimizdaFragment newInstance(String param1, String param2) {
        HakkimizdaFragment fragment = new HakkimizdaFragment();
